...
class NotifigationFarmScreen extends StatefulWidget {

  @override
  State<NotifigationFarmScreen> createState() => _NotifigationFarmScreenState();
}

class _NotifigationFarmScreenState extends State<NotifigationFarmScreen> {
  @override
      ...
      appBar: AppBar(
        ...
        leading: IconButton(
          onPressed: () => Navigator.pushReplacement(
              (context), MaterialPageRoute(builder: (context) => NavigationFarmScreen())),
          icon: Icon(
