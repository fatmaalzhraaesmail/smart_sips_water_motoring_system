...
import 'package:graduation_project/farmer%20system/profile_farm.dart';
                        ...
                        builder: (BuildContext context, FarmStates state) {
                          ...
                          return Container(
                              ...
                              child: GridView.builder(
                                ...
                                itemCount: cubit.images_farm.length,
                                gridDelegate:
                                ...
                                itemBuilder: (BuildContext context, int index) {
                                  return DashBoardCard(cubit.images_farm[index],
                                      cubit.titles[index], () {
                                    Navigator.pushReplacement(
                                        (context),
                                        MaterialPageRoute(
                                            builder: (context) =>
                                                cubit.Dashboard_Farm[index]));
                                  });
                                },
                              ));
                        }),
            ...
            ListTile(
              ...
              onTap: () {
                ...
                Navigator.pushReplacement(
                    (context),
                    MaterialPageRoute(
                        builder: (context) => NavigationFarmScreen()));
              },
            ),
            ListTile(
              ...
              onTap: () {
                ...
                Navigator.pushReplacement(
                    (context),
                    MaterialPageRoute(
                        builder: (context) => NavigationLabScreen()));
              },
            ),
            ListTile(
            ...
            ListTile(
              ...
              onTap: () {
                ...
                Navigator.pushReplacement(
                    (context),
                    MaterialPageRoute(
                        builder: (context) => ProfileFarmScreen()));
              },
            ),
            ListTile(
